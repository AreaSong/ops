    ...
    <div className="page">
      ...
      {available && status && <>
        ...
        {status.canManage && <section className="page-section">
          ...
          <form className="runner-fleet-update-form" onSubmit={(event) => void submit(event)}>
