...
| 变更类型 | L2：C1 控制面组件发布（单人批准）和 C2 单服务受控生命周期验证（独立双人批准） |
| 维护窗口 | 待审批人填写 |
| 变更负责人 | 待填写 |
| C1 批准人 | `song80184@gmail.com`；仅适用于控制面安装/更新 |
| C2 第一批准人 | 待填写；必须独立于 C2 操作人 |
| C2 第二批准人 | 待填写；必须独立于 C2 操作人和第一批准人 |
...
- [ ] 变更编号、窗口、操作人、C1 单人批准人、C2 两名批准人和沟通渠道已填写。
...
**批准规则**：C1 仅覆盖 Runner/Web 控制面安装或更新，按 L2 由 `song80184@gmail.com` 单人批准；该例外不改变 C2 生命周期、恢复、批量、Compose、终端或 Kubernetes 等高风险能力的双人审批要求。
...
| --- | --- | --- | --- |
| 变更负责人 | 待填写 | 待填写 | 待填写 |
| C1 批准人 | `song80184@gmail.com` | 待填写 | 待填写 |
| C2 第一批准人 | 待填写 | 待填写 | 待填写 |
| C2 第二批准人 | 待填写 | 待填写 | 待填写 |
| C0 放行 | 待填写 | 待填写 | 待填写 |
| C1 放行 | 待填写 | 待填写 | 待填写 |
| C2 放行 | 待填写 | 待填写 | 待填写 |
| 观察收口 | 待填写 | 待填写 | 待填写 |
