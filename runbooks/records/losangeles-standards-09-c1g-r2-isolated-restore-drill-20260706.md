...
- 后续更新：2026-07-06 已完成 Postgres 临时容器恢复演练，验证 `.sql.gz` 可恢复到隔离数据库；记录见 `runbooks/records/losangeles-standards-09-c1h-postgres-isolated-restore-drill-20260706.md`。
